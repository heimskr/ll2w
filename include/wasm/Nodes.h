...
namespace LL2W {
	...
	struct WASMPrintNode: public WASMBaseNode {
		const std::string *rs;
		WASMPrintType type;
	...
	struct WASMSleepRNode: public WASMBaseNode {
		const std::string *rs;
	...
	struct WASMPageNode: public WASMBaseNode {
		bool on;
	...
	struct WASMSetptINode: public WASMBaseNode {
		Immediate imm;
